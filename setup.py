...
if sys.version_info < (2, 6):
    print "snode only supports Python 2.6 and higher"
    sys.exit(1)
...
setup(
    ...
    description="A small web framework written in python using dependency injection technology.",
    ...
    url='http://snode.refnode.com',
    license='Apache Software License (http://www.apache.org/licenses/LICENSE-2.0)',
    namespace_packages=['snode'],
    package_dir={'': 'src'},
